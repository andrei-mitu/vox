...
### `routes` [planned — UI Phase 1]

Origin/destination pairs with optional distance and transit-day estimates. Referenced by `trips` (FK `route_id`).
...
See [[03-UI-Navigation]] for the full Routes feature plan.
...
| `0002_tricky_mandarin.sql`     | Added clients table                                                   |
| _(next)_                       | Add routes table (UI Phase 1)                                         |
