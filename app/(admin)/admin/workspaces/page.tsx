import { Badge, Button, Heading, Table, Text } from '@radix-ui/themes';
...
export default async function WorkspacesPage() {
    ...
    return (
        <div className="p-8 max-w-5xl">
            <Heading size="6" mb="2">Workspaces</Heading>
            <Text size="2" color="gray" mb="6" as="p">
                {teams.length} workspace{teams.length !== 1 ? 's' : ''} registered. Click Enter to access workspace as a user.
            </Text>

            {teams.length === 0 ? (
                <Text size="3" color="gray">No workspaces yet.</Text>
            ) : (
